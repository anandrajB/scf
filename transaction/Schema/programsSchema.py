...
from transaction.models import workmodel, ProgramType, Programs
...
class createPrograms(graphene.Mutation):
    ...
    def mutate(self, root, model_id, party_id, programtype_id, finance_type, currency, max_total_limit, expiry, max_finance_percentage, max_age_for_repayment, minimum_period, maximum_period,
        ...
        _program = Programs.objects.create(model=model, party=party, program_model=programtype, finance_type=finance_type, currency=currency, max_total_limit=max_total_limit, expiry=expiry, max_finance_percentage=max_finance_percentage, max_age_for_repayment=max_age_for_repayment,
