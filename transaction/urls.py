...
urlpatterns = [
    ...
    path('program/transition/submit/<int:pk>/',SubmitTransitionApiView.as_view(),name='initial-submit'),
    path('program/transition/reject/<int:pk>/',RejectedSignApi.as_view(),name='reject-transition'),
