...
@api_view(['GET', 'PATCH'])
def start_draft(self, pk):
    obj = generics.get_object_or_404(workevents, id=pk)
    obj.start()
    obj.save()
    return Response("Changed to A")
