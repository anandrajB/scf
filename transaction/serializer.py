...
from .models import Actions, Programs, submodels, workflowitems
from accounts.models import User, signatures,  Parties, userprocessauth
...
class Programcreateserializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        work = workflowitems.objects.create(
            program=program, current_from_party=from_party,sign = sign ,current_to_party=to_party, event_users=event_user)
        work.save()
