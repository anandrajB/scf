...
from accounts.models import  signatures  ,  Parties , customer
...
class Workitemserializer(serializers.ModelSerializer):
    ...
    event_users = serializers.SlugRelatedField(read_only = True , slug_field='display_name')
...
class Programcreateserializer(serializers.Serializer):
    ...
    event_user = serializers.PrimaryKeyRelatedField(queryset = customer.objects.all())
    ...
    def create(self, validated_data):
        ...
        work.save()
        event = workevents.objects.create(workitems=work,from_party = from_party , to_party = to_party)
        event.save()
        sign = signatures.objects.create(party_belongs = party , workflowitem = work )
        sign.save()
        return program
