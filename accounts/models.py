...
class User(AbstractUser):
    ...
    user_type = models.CharField(null= True ,blank=True,choices=ROLES,max_length=10)
...
class workflowitems(models.Model):
    ...
    initial_state = models.CharField(choices=STATE_TYPE,default='DRAFT',max_length=15)
    current_state = models.CharField(choices=STATE_TYPE,default='DRAFT',max_length=15)
...
class workevents(models.Model):
    ...
    event_user = models.ForeignKey(customer,on_delete=models.CASCADE,related_name='customername')
