...
class customer(models.Model):
    ...
    party_type_id = models.ForeignKey(Parties,on_delete=models.CASCADE,related_name='Parties')
...
class workflowitems(models.Model):
    ...
    # pros = models.OneToOneField(Programs,on_delete=models.CASCADE)
...
class workevents(models.Model):
    ...
    workitems = models.ForeignKey(workflowitems,on_delete=models.CASCADE,related_name='workevent')
