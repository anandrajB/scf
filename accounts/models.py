...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    # is_administrator -> a party's administrator who can create signatures and actions for his party
    # is_administrator == True  -> can login in admin_panel with only minimal permissions
    @property
    def is_staff(self):
        return self.is_administrator

    # is_master_admin is the user who maintains all the permissions and  admin-panel
    @property
...
class signatures(models.Model):
    ...
    def __str__(self):
        return "%s belongs to - %s"%(self.model , self.party)
